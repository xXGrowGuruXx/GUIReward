package me.xxgrowguruxx.adminshop.timer;
    ...
    public static GuiAction<InventoryClickEvent> performAction(int slot, Player player, GUIReward instance) {
        return event -> {
            ...
            if (event.isRightClick()) {
                ...
                String currentTimer = slotSection.getString("Timer");
                ...
                slotSection.set("Timer", newTimer);
