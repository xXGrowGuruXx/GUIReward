...
public class discountTimer {
    ...
    public static GuiAction<InventoryClickEvent> performAction(int slot, Player player, GUIReward instance) {
        return event -> {
            ...
            if (slotSection != null) {
                String timer = slotSection.getString("discountTime");
            ...
            itemMeta.displayName(Component.text(getMessage("discountTimer")));
            itemMeta.lore(lore);
            ...
            Component set10Lore1 = Component.text(getMessage("put10RECHTS"));
            Component set10Lore2 = Component.text(getMessage("put10LINKS"));
            GuiItem set10 = ItemBuilder.from(Material.OAK_SIGN)
                    .name(Component.text(getMessage("put10Name")))
                    .lore(set10Lore1, set10Lore2)
                    .asGuiItem(click -> {
                        GuiAction<InventoryClickEvent> action = put10.performAction(slot, player, instance);
                        action.execute(click); // Führt das Klickereignis aus
                    });

            Component set30Lore1 = Component.text(getMessage("put30RECHTS"));
            Component set30Lore2 = Component.text(getMessage("put30LINKS"));
            GuiItem set30 = ItemBuilder.from(Material.OAK_SIGN)
                    .name(Component.text(getMessage("put30Name")))
                    .lore(set30Lore1, set30Lore2)
                    .asGuiItem(click -> {
                        GuiAction<InventoryClickEvent> action = put30.performAction(slot, player, instance);
                        action.execute(click); // Führt das Klickereignis aus
                    });

            Component set1Lore1 = Component.text(getMessage("put1RECHTS"));
            Component set1Lore2 = Component.text(getMessage("put1LINKS"));
            GuiItem set1 = ItemBuilder.from(Material.OAK_SIGN)
                    .name(Component.text(getMessage("put1Name")))
                    .lore(set1Lore1, set1Lore2)
                    .asGuiItem(click -> {
                        GuiAction<InventoryClickEvent> action = put1.performAction(slot, player, instance);
                        action.execute(click); // Führt das Klickereignis aus
                    });

            Component set5Lore1 = Component.text(getMessage("put5RECHTS"));
            Component set5Lore2 = Component.text(getMessage("put5LINKS"));
            GuiItem set5 = ItemBuilder.from(Material.OAK_SIGN)
                    .name(Component.text(getMessage("put5Name")))
                    .lore(set5Lore1, set5Lore2)
                    .asGuiItem(click -> {
                        GuiAction<InventoryClickEvent> action = put5.performAction(slot, player, instance);
                        action.execute(click); // Führt das Klickereignis aus
                    });
